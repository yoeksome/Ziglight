...
//#define LED1_POLARITY     ACTIVE_HIGH
  ...
  /* 3 - Yellow */
  #define LED3_BV           BV(1)//BV(4) //BY LIU
  #define LED3_SBIT         P1_1//P1_4 //BY LIU
...
/* S1 */
//#define PUSH1_BV          BV(1)//by liu
//#define PUSH1_SBIT        P0_1//by liu
/**************by liu***************/
...
/**************end  ***************/
#if defined (HAL_BOARD_CC2530EB_REV17)
  #define PUSH1_POLARITY    ACTIVE_LOW//ACTIVE_HIGH//by liu
